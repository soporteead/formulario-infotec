<?php
    require_once 'php/conexion.php';
     ...
     $state = "SELECT * FROM estados";
     $result2 = mysqli_query($conn, $state);

     $genero = "SELECT * FROM genero";
     $result3 = mysqli_query($conn, $genero);

     $opciones = "SELECT * FROM opciones";
     $result4 = mysqli_query($conn, $opciones);

     $carreras = "SELECT * FROM carreras";
     $result5 = mysqli_query($conn, $carreras);
?>
<!DOCTYPE html>
<html lang="es">
<head>
...
<body>
              ...
              <div class="collapse navbar-collapse" id="navbarNavDropdown">
                <ul class="navbar-nav ms-auto">
                  ...
                  <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle text-uppercase fw-bold enlaces" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                      REGISTRO
                    </a>
                  ...
                  <li class="nav-item">
                    <a class="nav-link text-uppercase fw-bold enlaces" href="http://foprodesemiconductores.aguascalientes.tecnm.mx/login.php" target="_blank">Plataforma virtual</a>
                  </li>
                  <li class="nav-item">
    ...
    <section class="container form-section">
        ...
        <form id="form-estudiantes">
            <div class="row g-3">
                ...
                <div class="col-md-5">
                    <label for="carrera" class="form-label">Carrera<span style="color:red">*</span></label>
                    <select name="carrera" id="carrera" class="form-select">
                        <option value="">Seleccione su Carrera</option>
                        <?php
                            foreach($result5 as $r5){
                                echo '<option value="'.$r5["id"].'">'.$r5["name"].'</option>';
                            }
                        ?>
                    </select>
                </div>
                <div class="col-md-2">
                    <label for="semester" class="form-label">Semestre<span style="color:red">*</span></label>
                    <input type="number" class="form-control" name="semester" id="semester" min="1" max="12" required>
                </div>
                <div class="col-md-2">
                    <label for="promedio" class="form-label">Promedio<span style="color:red">*</span></label>
                    <input type="text" class="form-control" name="promedio" id="promedio" placeholder="ej. 96" require>
                </div>
                <div class="col-md-3">
                    <label for="opciones" class="form-label">Opción<span style="color:red">*</span></label>
    ...
    <footer class="container-fluid p-4 footer responsive">
        ...
        <div class="copyright">
            ...
            <p>&copy; 2024 Tecnológico Nacional de México</p>
        </div>
        <div class="contact">
            <h5 class="title-footer">Informes</h5>
            <p class="email-contact">Correo Electrónico: <br><a href="mailto:">fabricanacionaldesoftware@aguascalientes.tecnm.mx</a>
...
<script>
    ...
    let select_box_element4 = document.querySelector('#carrera');
    dselect(select_box_element4, {
      search: true
    });
    let select_box_element5 = document.querySelector('#opciones');
    dselect(select_box_element5, {
      search: true
    });
</script>